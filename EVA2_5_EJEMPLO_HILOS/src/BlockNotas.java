...
/**
 *
 * @author MandoParra 22550032 10/10/2023
 */
...
private void actualizarUI(int cant){
    SwingUtilities.invokeLater(new Runnable(){

        @Override
        public void run() {
            
            lblContar.setText("" + txtArTexto.getText().length());
        }
    ...
    private void initComponents() {
        ...
        lblContar.setText("Textirijillo");

        txtArTexto.setColumns(20);
        txtArTexto.setRows(5);
        jScrollPane2.setViewportView(txtArTexto);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblContar, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE)
